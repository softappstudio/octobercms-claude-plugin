...
4.  Each H2 and H3 header should have a link defined as `<a name="page-cycle-handlers"></a>`
...
11.  See the [cms/themes/pages.md](https://github.com/octobercms/docs/blob/develop/3.x/cms/themes/pages.md) or [cms/themes/themes.md](https://github.com/octobercms/docs/blob/develop/3.x/cms/themes/themes.md) files for your reference.

### [](#psr-exceptions)Exceptions to PSR standards

There are some exceptions to the PSR standard used by October CMS.

### [](#psr-exception-methods)Controller Methods
...
An exception to the PSR-2 standard to allow **snake\_case** should be granted for these scenarios.

### [](#psr-exception-newline-expressions)Expressions on New Line
...
### [](#developer-standards)Developer Standards and Patterns
...
See the [publishing packages article](https://docs.octobercms.com/3.x/extend/resources/publishing-packages.html) for more details on additional requirements.

### [](#variable-naming)PHP Variable Naming

Use **camelCase** everywhere except for the following:

1.  Database attributes and relationships should use **snake\_case**
2.  Postback parameters and HTML elements should use **snake\_case**
3.  Language keys should use **snake\_case**

### [](#element-naming)HTML Element Naming

Form element names should use snake\_case (underscores)

```
<input name="first_name">
```

Where the name is an array, the array keys can be either StudlyCase or snake\_case.
...
When specifying [event names](https://docs.octobercms.com/3.x/extend/services/event.html). The term *after* is not used in Events, only the term *before* is used. For example:
...
### [](#db-table-naming)Database Table Naming
